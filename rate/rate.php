				...
				<fieldset>
					...
					<ul class="rate-list">
						...
						<div>
							...
							<input type="hidden" name="canUploadPic200004843766017" value="false" />
							<input type="hidden" name="leafCatId200004843766017" value="50016737" />
							<input type="hidden" name="rootCatId200004843766017" value="50010728" />
							<input type="hidden" name="auctionPrice200004843766017" value="85.0" />
						</div>
							...
							<div class="item-rate-main">
								<div class="item-rate-act">
									<div class="rate-control">
										<ul>
											<li class="good">
												<label for="rate-good-200004843766017">
													<input  id="rate-good-200004843766017" name="rates200004843766017" type="radio" value="1" class="good-rate"/>
													<i class="icon icon-rank icon-good"></i> <span class="label-hidden">好评</span> </label>
											</li>
											<li class="normal">
												<label for="rate-normal-200004843766017">
													<input  id="rate-normal-200004843766017" name="rates200004843766017" type="radio" value="0" class="noraml-rate"/>
													<i class="icon icon-rank icon-normal"></i> <span class="label-hidden">中评</span> </label>
											</li>
											<li class="bad">
												<label for="rate-bad-200004843766017">
													<input  id="rate-bad-200004843766017" name="rates200004843766017" type="radio" value="-1" class="bad-rate"/>
													<i class="icon icon-rank icon-bad"></i> <span class="label-hidden">差评</span> </label>
											</li>
										</ul>
									</div>
								...
								<div class="rate-msg-box">
									<div class="bd">
										<div class="textinput ph-hide">
											<span class="ph-label"></span>
											<textarea name="rateContents200004843766017" maxlength="500" aria-labelby="label-ti-200004843766017" class="rate-msg"></textarea>
											<div class="text-counter">
												<strong class="r-t-counter">500</strong>字
											</div>
										</div>
								...
								<div class='share-box'>
									<input id="share-rate-200004843766017" name="sharePrivacy200004843766017" value="true" type="checkbox"  class="rate-share"/>
									<label for="share-rate-200004843766017">晒到个人主页</label>
									<input id="annoy-rate-200004843766017" name="anony200004843766017" value="1" type="checkbox"  class="rate-annoy"/>
									<input type="hidden" name="forceAnnoy200004843766017" value="false"/>
									<label for="annoy-rate-200004843766017">匿名评价</label>
								</div>
							</div>
						</li>
					</ul>
